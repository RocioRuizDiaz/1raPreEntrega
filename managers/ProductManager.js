...
export default class ProductManager {
  ...
  //Obtiene la lista de productos almacenados en el archivo JSON.
  ...
  addProduct = async (obj) => {
    const {title, description, price,category,status=true, code, stock}=obj
...
// // await productmanager.addProduct("titlle","description",1500,"url","ONEPIECE002",30)
